  ...
  return (
    <li
      className={cn(
        ...
        LAYOUT.container,
        option.disabled ? "opacity-50 cursor-not-allowed" : cn("cursor-pointer", theme.selectOptionHover),
    ...
    >
      ...
      {isSelected && !multiple && (
        <span className={cn("absolute inset-y-0 right-0 flex items-center text-(--color-primary)", LAYOUT.checkIconPadding)}>
