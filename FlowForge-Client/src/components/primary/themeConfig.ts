export const theme = {
  ...
  // ── ZModal ────────────────────────────────────────────────────────────────
  modalContainer: "bg-white dark:bg-slate-800 ring-1 ring-slate-900/5 dark:ring-slate-700/30 shadow-2xl",
  ...
  selectOptionHover: "hover:bg-pink-50 dark:hover:bg-pink-950/50 hover:text-pink-900 dark:hover:text-pink-300",
  selectOptionSelected: "bg-pink-50 dark:bg-pink-950/40 text-pink-900 dark:text-pink-300 font-medium",
  ...
  selectOptionCheckboxUnchecked: "border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-700",
  selectScrollbar:
  ...
  sectionTitle: "text-xs font-semibold text-pink-400 uppercase tracking-wider border-b border-pink-100 dark:border-pink-900/70",
