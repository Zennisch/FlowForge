...
*Last updated: 2026-03-21 — Implemented Compensation Phase 1 scaffold: workflow step compensation contract (schema + DTO), snapshot propagation, compensation executor (noop/http), reverse-order compensation dispatch for completed steps, and compensation audit events. Added regression tests in compensate.service.spec.ts and kept existing execution/event suites green.*
